...
- SQL Server with SSDT/DACPAC (no schema changes in this feature) (017-crosscut-hardening-phase0)
...
## Recent Changes
- 017-crosscut-hardening-phase0: Added C# / .NET 10.0 (SDK 10.0.0) + ASP.NET Core MVC, MediatR 14.1, FluentValidation 12.1, Mapperly 4.x, EF Core 10.x
