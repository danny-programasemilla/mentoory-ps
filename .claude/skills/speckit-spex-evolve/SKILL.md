---
name: speckit-spex-evolve
description: Handle spec/code mismatches through AI-guided analysis and user-controlled
  evolution
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: spex:commands/speckit.spex.evolve.md
---
...
**If spec.md is missing:** Cannot proceed with evolution. Use `/speckit-specify` first.

**If plan.md or tasks.md exist:**
- These were generated by spec-kit and must be kept in sync
- After modifying the spec, regenerate dependent artifacts using:
  - `/speckit-plan` - Regenerate plan
  - `/speckit-tasks` - Regenerate tasks
  - `/speckit-analyze` - Verify consistency

**CRITICAL: Never manually edit plan.md or tasks.md. Always regenerate via /speckit-* commands after spec changes.**
...
**If spec was updated (Options A or C), regenerate dependent artifacts:**
...
After regeneration, verify artifacts are in sync using `/speckit-analyze`.

**Confirm:**
- Spec and code now aligned
- Tests still passing
- No regressions introduced
- All spec-kit artifacts regenerated and in sync
