...
/// <param name="UserAgentString">The raw User-Agent header from HttpContext.</param>
/// <param name="FailedAttemptCount">Consecutive failed attempts before this login.</param>
