...
/// <summary>
/// Read model that mirrors basic user profile data from the Identity domain.
/// Synchronized via integration events (UserRegisteredEvent).
/// Used for queries that need user details within the Authorization bounded context.
/// </summary>
