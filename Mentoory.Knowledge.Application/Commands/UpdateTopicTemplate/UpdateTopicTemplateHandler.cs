...
/// <summary>
/// Handles the update of a topic within a knowledge structure template.
/// </summary>
public class UpdateTopicTemplateHandler : BaseCommandHandler<UpdateTopicTemplateCommand>
{
    private readonly IKnowledgeStructureTemplateRepository _repository;

    /// <summary>
    /// Initializes a new instance of the <see cref="UpdateTopicTemplateHandler"/> class.
    /// </summary>
    /// <param name="repository">The knowledge structure template repository.</param>
    public UpdateTopicTemplateHandler(IKnowledgeStructureTemplateRepository repository)
    {
    ...
    public override async Task<Result> Handle(
        UpdateTopicTemplateCommand request,
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            template.UpdateTopic(request.TopicExternalId, request.Name, request.Description);
        }
