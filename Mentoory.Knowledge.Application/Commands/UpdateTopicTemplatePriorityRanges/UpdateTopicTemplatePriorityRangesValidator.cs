...
/// <summary>
/// Validator for the <see cref="UpdateTopicTemplatePriorityRangesCommand"/>.
/// </summary>
public class UpdateTopicTemplatePriorityRangesValidator : AbstractValidator<UpdateTopicTemplatePriorityRangesCommand>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="UpdateTopicTemplatePriorityRangesValidator"/> class
    /// and configures validation rules including per-band bounds and cross-band overlap detection.
    /// </summary>
    public UpdateTopicTemplatePriorityRangesValidator()
    {
    ...
    /// </summary>
    private static bool NotHaveOverlappingRanges(UpdateTopicTemplatePriorityRangesCommand cmd)
    {
