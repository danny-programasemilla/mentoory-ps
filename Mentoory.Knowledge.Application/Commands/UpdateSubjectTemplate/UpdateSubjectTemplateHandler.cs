...
/// <summary>
/// Handles updates to a subject within a knowledge structure template.
/// </summary>
public class UpdateSubjectTemplateHandler : BaseCommandHandler<UpdateSubjectTemplateCommand>
{
    private readonly IKnowledgeStructureTemplateRepository _repository;

    /// <summary>
    /// Initializes a new instance of the <see cref="UpdateSubjectTemplateHandler"/> class.
    /// </summary>
    /// <param name="repository">The knowledge structure template repository.</param>
    public UpdateSubjectTemplateHandler(IKnowledgeStructureTemplateRepository repository)
    {
    ...
    public override async Task<Result> Handle(
        UpdateSubjectTemplateCommand request,
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            template.UpdateSubject(request.SubjectExternalId, request.Name, request.Description);
        }
