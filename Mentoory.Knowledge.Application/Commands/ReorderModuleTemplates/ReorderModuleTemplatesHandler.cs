...
/// <summary>
/// Handles the reordering of modules within a knowledge structure template.
/// </summary>
public class ReorderModuleTemplatesHandler : BaseCommandHandler<ReorderModuleTemplatesCommand>
{
    private readonly IKnowledgeStructureTemplateRepository _repository;

    /// <summary>
    /// Initializes a new instance of the <see cref="ReorderModuleTemplatesHandler"/> class.
    /// </summary>
    /// <param name="repository">The knowledge structure template repository.</param>
    public ReorderModuleTemplatesHandler(IKnowledgeStructureTemplateRepository repository)
    {
    ...
    public override async Task<Result> Handle(
        ReorderModuleTemplatesCommand request,
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            template.ReorderModules(request.ModuleExternalIdsInOrder);
        }
