...
/// <summary>
/// Handles the update of a module within a knowledge structure template.
/// </summary>
public class UpdateModuleTemplateHandler : BaseCommandHandler<UpdateModuleTemplateCommand>
{
    private readonly IKnowledgeStructureTemplateRepository _repository;

    /// <summary>
    /// Initializes a new instance of the <see cref="UpdateModuleTemplateHandler"/> class.
    /// </summary>
    /// <param name="repository">The knowledge structure template repository.</param>
    public UpdateModuleTemplateHandler(IKnowledgeStructureTemplateRepository repository)
    {
        ...
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            template.UpdateModule(request.ModuleExternalId, request.Name, request.Description);
        }
