...
/// <summary>
/// Handles the update of a module within a knowledge structure (project clone).
/// </summary>
public class UpdateModuleHandler : BaseCommandHandler<UpdateModuleCommand>
{
    private readonly IKnowledgeStructureRepository _repository;

    /// <summary>
    /// Initializes a new instance of the <see cref="UpdateModuleHandler"/> class.
    /// </summary>
    /// <param name="repository">The knowledge structure repository.</param>
    public UpdateModuleHandler(IKnowledgeStructureRepository repository)
    {
        ...
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            structure.UpdateModule(request.ModuleExternalId, request.Name, request.Description);
        }
