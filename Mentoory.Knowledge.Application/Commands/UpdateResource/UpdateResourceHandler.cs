...
/// <summary>
/// Handles the update of a resource within a knowledge structure (project clone).
/// </summary>
public class UpdateResourceHandler : BaseCommandHandler<UpdateResourceCommand>
{
    private readonly IKnowledgeStructureRepository _repository;

    /// <summary>
    /// Initializes a new instance of the <see cref="UpdateResourceHandler"/> class.
    /// </summary>
    /// <param name="repository">The knowledge structure repository.</param>
    public UpdateResourceHandler(IKnowledgeStructureRepository repository)
    {
